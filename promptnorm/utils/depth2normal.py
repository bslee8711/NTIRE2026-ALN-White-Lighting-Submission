...
DEPTH_PATH = "/path/to/depth"  # Replace with your depth images path
for i in tqdm(glob(os.path.join(DEPTH_PATH, "*"))):
    ...
    out_path = os.path.join(DEPTH_PATH.replace("/depth", "/normal"), i.split("/")[-1].replace("_in.png", "_normal.png"))
